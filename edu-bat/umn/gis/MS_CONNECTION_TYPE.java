...
public final class MS_CONNECTION_TYPE {
  ...
  public final static MS_CONNECTION_TYPE MS_SDE = new MS_CONNECTION_TYPE("MS_SDE");
  ...
  private static MS_CONNECTION_TYPE[] swigValues = { MS_INLINE, MS_SHAPEFILE, MS_TILED_SHAPEFILE, MS_SDE, MS_OGR,
      MS_UNUSED_1, MS_POSTGIS, MS_WMS, MS_ORACLESPATIAL, MS_WFS, MS_GRATICULE, MS_MYSQL, MS_RASTER, MS_PLUGIN, MS_UNION,
      MS_UVRASTER };
