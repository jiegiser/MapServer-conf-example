...
public class shapeObj {
  ...
  public int project(projectionObj projin, projectionObj projout) {
    return mapscriptJNI.shapeObj_project(swigCPtr, this, projectionObj.getCPtr(projin), projin,
  ...
  public int draw(mapObj map, layerObj layer, imageObj image) {
    return mapscriptJNI.shapeObj_draw(swigCPtr, this, mapObj.getCPtr(map), map, layerObj.getCPtr(layer), layer,
        imageObj.getCPtr(image), image);
  }
