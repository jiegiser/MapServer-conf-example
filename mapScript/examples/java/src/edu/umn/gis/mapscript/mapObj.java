...
public class mapObj {
  ...
  public configObj getConfig() {
    long cPtr = mapscriptJNI.mapObj_config_get(swigCPtr, this);
  ...
  public void setSldurl(String value) {
    mapscriptJNI.mapObj_sldurl_set(swigCPtr, this, value);
  }

  public String getSldurl() {
    return mapscriptJNI.mapObj_sldurl_get(swigCPtr, this);
  }
  ...
  public mapObj(String filename, configObj config) {
    this(mapscriptJNI.new_mapObj(filename, configObj.getCPtr(config), config), true);
  }
  ...
  public void pixelToGeoref(double pixPosX, double pixPosY, pointObj geoPos) {
    mapscriptJNI.mapObj_pixelToGeoref(swigCPtr, this, pixPosX, pixPosY, pointObj.getCPtr(geoPos), geoPos);
  }

  public double getRotation() {
    return mapscriptJNI.mapObj_getRotation(swigCPtr, this);
  }
  ...
  public outputFormatObj getOutputFormat(int i) {
    long cPtr = mapscriptJNI.mapObj_getOutputFormat(swigCPtr, this, i);
    return (cPtr == 0) ? null : new outputFormatObj(cPtr, true);
  }
  ...
  public imageObj drawLegend(int scale_independent) {
    long cPtr = mapscriptJNI.mapObj_drawLegend(swigCPtr, this, scale_independent);
    return (cPtr == 0) ? null : new imageObj(cPtr, true);
  }
  ...
  public String generateSLD(String sldVersion) {
    return mapscriptJNI.mapObj_generateSLD(swigCPtr, this, sldVersion);
  }

  public String processTemplate(int bGenerateImages, SWIGTYPE_p_p_char names, SWIGTYPE_p_p_char values, int numentries) {
    return mapscriptJNI.mapObj_processTemplate(swigCPtr, this, bGenerateImages, SWIGTYPE_p_p_char.getCPtr(names), SWIGTYPE_p_p_char.getCPtr(values), numentries);
  }

  public String processLegendTemplate(SWIGTYPE_p_p_char names, SWIGTYPE_p_p_char values, int numentries) {
    return mapscriptJNI.mapObj_processLegendTemplate(swigCPtr, this, SWIGTYPE_p_p_char.getCPtr(names), SWIGTYPE_p_p_char.getCPtr(values), numentries);
  }

  public String processQueryTemplate(SWIGTYPE_p_p_char names, SWIGTYPE_p_p_char values, int numentries) {
    return mapscriptJNI.mapObj_processQueryTemplate(swigCPtr, this, SWIGTYPE_p_p_char.getCPtr(names), SWIGTYPE_p_p_char.getCPtr(values), numentries);
  }
  ...
  public String convertToString() {
    return mapscriptJNI.mapObj_convertToString(swigCPtr, this);
  }

  public void applyDefaultSubstitutions() {
    mapscriptJNI.mapObj_applyDefaultSubstitutions(swigCPtr, this);
  }

  public void applySubstitutions(SWIGTYPE_p_p_char names, SWIGTYPE_p_p_char values, int npairs) {
    mapscriptJNI.mapObj_applySubstitutions(swigCPtr, this, SWIGTYPE_p_p_char.getCPtr(names), SWIGTYPE_p_p_char.getCPtr(values), npairs);
  }

  public int zoomPoint(int zoomfactor, pointObj poPixPos, int width, int height, rectObj poGeorefExt, rectObj poMaxGeorefExt) {
    return mapscriptJNI.mapObj_zoomPoint(swigCPtr, this, zoomfactor, pointObj.getCPtr(poPixPos), poPixPos, width, height, rectObj.getCPtr(poGeorefExt), poGeorefExt, rectObj.getCPtr(poMaxGeorefExt), poMaxGeorefExt);
  }

  public int zoomRectangle(rectObj poPixRect, int width, int height, rectObj poGeorefExt, rectObj poMaxGeorefExt) {
    return mapscriptJNI.mapObj_zoomRectangle(swigCPtr, this, rectObj.getCPtr(poPixRect), poPixRect, width, height, rectObj.getCPtr(poGeorefExt), poGeorefExt, rectObj.getCPtr(poMaxGeorefExt), poMaxGeorefExt);
  }

  public int zoomScale(double scale, pointObj poPixPos, int width, int height, rectObj poGeorefExt, rectObj poMaxGeorefExt) {
    return mapscriptJNI.mapObj_zoomScale(swigCPtr, this, scale, pointObj.getCPtr(poPixPos), poPixPos, width, height, rectObj.getCPtr(poGeorefExt), poGeorefExt, rectObj.getCPtr(poMaxGeorefExt), poMaxGeorefExt);
  }
