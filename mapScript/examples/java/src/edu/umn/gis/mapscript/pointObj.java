...
public class pointObj {
  ...
  public void setZ(double value) {
    mapscriptJNI.pointObj_z_set(swigCPtr, this, value);
  }

  public double getZ() {
    return mapscriptJNI.pointObj_z_get(swigCPtr, this);
  }

  public void setM(double value) {
    mapscriptJNI.pointObj_m_set(swigCPtr, this, value);
  }

  public double getM() {
    return mapscriptJNI.pointObj_m_get(swigCPtr, this);
  }

  public int project(projectionObj projin, projectionObj projout) {
    return mapscriptJNI.pointObj_project__SWIG_0(swigCPtr, this, projectionObj.getCPtr(projin), projin, projectionObj.getCPtr(projout), projout);
  }

  public int project(reprojectionObj reprojector) {
    return mapscriptJNI.pointObj_project__SWIG_1(swigCPtr, this, reprojectionObj.getCPtr(reprojector), reprojector);
  }

  public int draw(mapObj map, layerObj layer, imageObj image, int classindex, String text) {
    return mapscriptJNI.pointObj_draw(swigCPtr, this, mapObj.getCPtr(map), map, layerObj.getCPtr(layer), layer, imageObj.getCPtr(image), image, classindex, text);
  }
